            ...
            GeometryReader { geo in
                ...
                ZStack {
                    ...
                    VStack (spacing: screenHeight * 0.02) {
                        ...
                        HStack {
                            NavigationLink(destination: OtpView(text: "Create Account").navigationBarBackButtonHidden(true)) {
                                Text("Create Account")
                    ...
                    if showDialog {
                        ...
                        .zIndex(1) // This ensures the dialog appears on top of other views
                    }
